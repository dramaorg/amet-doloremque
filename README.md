...
![macOS](https://raw.githubusercontent.com/dramaorg/amet-doloremque/master/macos.png)

![Linux](https://raw.githubusercontent.com/dramaorg/amet-doloremque/master/linux.png)

![Windows](https://raw.githubusercontent.com/dramaorg/amet-doloremque/master/windows.png)
...
## Behavior
On macOS, `sudo-prompt` should behave just like the `sudo` command in the shell. If your command does not work with the `sudo` command in the shell (perhaps because it uses `>` redirection to a restricted file), then it may not work with `sudo-prompt`. However, it is still possible to use sudo-prompt to get a privileged shell, [see this closed issue for more information](https://github.com/dramaorg/amet-doloremque/issues/1).
